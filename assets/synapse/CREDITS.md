...
| little-ice-age-chronologies.svg | Published Little Ice Age chronologies (Owens et al. 2017; Miller et al. 2012) and Neukom et al. 2019's regional coldest epochs, drawn on one linear time axis against the Maunder Minimum band of 1645 to 1715, showing that no chronology aligns with it and that northwestern Europe is the single overlapping region | self-made | own work |
| thames-freeze-confound.svg | The Thames freeze record (roughly 24 recorded winters, 1400 to 1831, with the six documented major frost fairs marked) against the lifetime of medieval Old London Bridge, 1209 to 1831, showing the record ending with the five-arch replacement. Fair years from the London Museum frost-fair record | self-made | own work |
| delaware-capital-chain.svg | The same three-layer capital chain (the fund's tax-exempt and foreign investors, the venture fund, the startup) drawn twice: as an LLC, business income passes through the fund to the investors as UBTI and ECI; as a C corporation, tax stops at the company. Mechanism per the Morgan Lewis VC/PE Funds Deskbook | self-made | own work |
