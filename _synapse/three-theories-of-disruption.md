---
title: "Everyone calls it disruptive. Two of three theories agree."
date: 2026-07-29
synapse: 6
...
<img src="/assets/synapse/three-theories-llm-test.svg" alt="Three rows, each a named theory of disruption tested against the frontier large language model. Schumpeter's creative destruction, an economy-wide gale remaking many industries at once, fits. Christensen's disruptive innovation, entering low-end or new-market and climbing up, does not fit, because the model entered at the expensive high end instead. Marketing's discontinuous innovation, defined by behaviour change demanded of the user, fits. Closing line: same word, three different questions, and the frontier LLM answers two of them yes and the one the term disruptive innovation actually names, no." style="max-width:100%;height:auto;">
...
- Christensen, Raynor & McDonald, ["What Is Disruptive Innovation?"](https://hbr.org/2015/12/what-is-disruptive-innovation), *Harvard Business Review*, Dec 2015, the piece naming Uber as the theory's flagship non-fitting case.
- Reinert & Reinert, ["Creative Destruction in Economics: Nietzsche, Sombart, Schumpeter"](https://link.springer.com/chapter/10.1007/978-0-387-32980-2_4), on the term's actual origin before Schumpeter.
