---
title: "Apollo's first Moon age came out older than the solar system"
date: 2026-08-12
synapse: 8
tags: [astronomy, archaeology, radiometric-dating, apollo, isotopes]
excerpt: "In January 1970 the first published radiometric age for lunar material was 4.66 billion years. The solar system is 4.567 billion years old. The number was impossible, nobody had made a mistake, and the gap turned out to be the finding."
image: /assets/heroes/apollo-first-moon-age.png
hero_hue: 215
---
...
<img src="/assets/synapse/dating-isotope-halflives.svg" alt="Five horizontal bars on a logarithmic scale of years from one thousand to one trillion. Carbon-14 to nitrogen-14 sits at 5,730 years and is the only pair archaeology uses. Four pairs used on rock sit far to the right: potassium-40 to argon-40 at 1.248 billion years, uranium-238 to lead-206 at 4.47 billion, rubidium-87 to strontium-87 at 48.8 billion, and samarium-147 to neodymium-143 at 106 billion." style="max-width:100%;height:auto;">
...
Archaeology runs on carbon-14 decaying to nitrogen-14, half-life 5,730 years, which the [National Park Service](https://www.nps.gov/subjects/geology/radiometric-age-dating.htm) puts to work over an effective range of about 100 to 50,000 years. Past that there is too little carbon-14 left in the sample to measure.
...
<img src="/assets/synapse/apollo11-two-answers.svg" alt="A scale of billions of years ago from 3.5 to 4.8. The crystalline rocks, measured by rubidium-strontium isochron, sit at 3.65 billion years plus or minus 0.06. The soil and breccia, measured two ways, sit as a band from 4.6 to 4.66 billion years. The modern accepted age of the Moon spans 4.35 to 4.51 billion. A dashed vertical line at 4.567 billion marks the age of the solar system, and the soil band is the only thing falling to the right of it." style="max-width:100%;height:auto;">

*Same landing site, same year of publication, a billion years between the answers.*

[Mitsunobu Tatsumoto and John Rosholt](https://www.science.org/doi/10.1126/science.167.3918.461) of the US Geological Survey ran uranium-thorium-lead on the fine dust and breccia and published a concordant age of 4.66 billion years in *Science* on 30 January 1970. Concordant is the strong word here. Several independent isotope ratios in that system agreed with each other, which is exactly the internal consistency check that normally tells you a date is trustworthy.

[Papanastassiou, Wasserburg and Burnett](https://www.sciencedirect.com/science/article/abs/pii/0012821X70900932) ran rubidium-strontium on six crystalline rocks from the same site and got 3.65 billion years, give or take 60 million. Tight cluster, six samples. Also trustworthy. They then ran the same method on the soil and got roughly 4.6 billion, agreeing with the USGS result on the dust while disagreeing with their own result on the rocks.
...
The modern age of the Moon sits between 4.35 and 4.51 billion years, [depending on whether you date whole rocks or individual zircon grains](https://www.science.org/doi/10.1126/sciadv.1602365). Not 4.66. Nothing is.
...
Absolute dates are also what let you test a story against a physical event, which is the machinery underneath [an earlier installment here](/synapse/geomythology-oral-tradition-as-geological-memory/) on oral traditions that turn out to encode real geology. Without a year attached to the eruption, the tradition is just a good story.
...
That is the part I keep turning over. The strongest signal in the Apollo 11 data was not the measurement that was right. It was the measurement that was impossible, sitting next to a correct one, refusing to be reconciled. [Last time](/synapse/gpu-useful-life-and-the-ai-buildout/) it was a number that companies openly call an estimate doing billions of dollars of work. This time it is a number that was never wrong, only misread, and pointed at ground nobody had walked on yet.

## Sources

- [Tatsumoto, M. and Rosholt, J. N., "Age of the Moon: An Isotopic Study of Uranium-Thorium-Lead Systematics of Lunar Samples," *Science* 167(3918), 461-463, 30 January 1970](https://www.science.org/doi/10.1126/science.167.3918.461), for the concordant 4.66 billion year result on dust and breccia. This is a USGS paper, and it is often miscited to the Caltech group below.
- [Papanastassiou, D. A., Wasserburg, G. J. and Burnett, D. S., "Rb-Sr ages of lunar rocks from the Sea of Tranquillity," *Earth and Planetary Science Letters* 8, 1-19, 1970](https://www.sciencedirect.com/science/article/abs/pii/0012821X70900932), for the 3.65 billion year isochron on six crystalline rocks and the roughly 4.6 billion year model age on the soil.
- [Radiometric Age Dating, US National Park Service](https://www.nps.gov/subjects/geology/radiometric-age-dating.htm), for the half-life table and carbon-14's 100 to 50,000 year effective range.
- [Dating Artifacts, Smithsonian Museum Conservation Institute](https://mci.si.edu/dating-artifacts), independently confirming carbon-14's 5,730 year half-life and 50,000 year ceiling.
- [Bouvier, A. and Wadhwa, M., "The age of the Solar System redefined by the oldest Pb-Pb age of a meteoritic inclusion," *Nature Geoscience*, 2010](https://www.nature.com/articles/ngeo941), for the 4.567 billion year figure that makes 4.66 impossible.
- [Barboni, M. et al., "Early formation of the Moon 4.51 billion years ago," *Science Advances*, 2017](https://www.science.org/doi/10.1126/sciadv.1602365), for the modern lunar age.
- [Willard Libby and Radiocarbon Dating, American Chemical Society National Historic Chemical Landmark](https://www.acs.org/education/whatischemistry/landmarks/radiocarbon-dating.html), for the 1946 method, the 1949 Curve of Knowns with James Arnold, and the 1960 Nobel.
