---
title: "The Sun went quiet for seventy years. The cold lasted five centuries."
date: 2026-08-20
synapse: 9
tags: [astronomy, history, climate, maunder-minimum, little-ice-age, grounding]
excerpt: "Between 1645 and 1715 the Sun almost stopped making sunspots, and Europe was famously cold. It is the standard illustration of solar activity touching human history. It fails on three independent counts, and the refutation was already sitting in my own notes, spread across three pages that never cited each other."
image: /assets/heroes/the-sun-and-the-little-ice-age.png
hero_hue: 28
---
...
<img src="/assets/synapse/little-ice-age-chronologies.svg" alt="A time axis from 1200 to 2000. A narrow vertical band marks the Maunder Minimum, 1645 to 1715. Four horizontal bars show published Little Ice Age chronologies, none of which start or end near that band: Owens and colleagues put the Little Ice Age at roughly 1440 to 1920; Miller and colleagues date its abrupt onset to 1275 to 1300 with intensification from 1430 to 1455. Three further bars show the coldest epoch arriving in different centuries in different places: the fifteenth century in the central and eastern Pacific, the seventeenth century in northwestern Europe, and the mid-nineteenth century across most of the globe. Only the northwestern Europe bar overlaps the Maunder Minimum band." style="max-width:100%;height:auto;">
...
The published chronologies do not agree with each other either, which is itself part of the finding. [Owens and colleagues](https://www.swsc-journal.org/articles/swsc/abs/2017/01/swsc170014/swsc170014.html), writing in the *Journal of Space Weather and Space Climate* in 2017, take the Little Ice Age as roughly 1440 to 1920 against a Maunder Minimum of roughly 1650 to 1715. [Miller and colleagues](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2011GL050168) push the onset earlier still, to between 1275 and 1300.
...
[Neukom and colleagues](https://www.nature.com/articles/s41586-019-1401-2), in *Nature* in 2019, reconstructed the past two thousand years region by region and found that the Little Ice Age has no spatial coherence at all. The coldest epoch arrives in the fifteenth century in the central and eastern Pacific. In the seventeenth century in northwestern Europe. In the mid-nineteenth century almost everywhere else.
...
[Ineson and colleagues](https://www.nature.com/articles/ngeo1282) proposed a route in 2011: reduced ultraviolet output changes stratospheric heating, which shifts the North Atlantic Oscillation, which produces northern-hemisphere winter cooling without much change in global mean temperature. My own solar constant page even carries the necessary ingredient, that extreme ultraviolet output is about ten times higher at solar maximum than at minimum.

So there is a mechanism. But [Chiodo and colleagues](https://www.columbia.edu/~lmp/paps/chiodo+etal-NATUREGEO-2019.pdf) then found the eleven-year solar signal in the North Atlantic Oscillation insignificant before the mid-1960s.
...
- [University of Cambridge, "Over-hunting walruses contributed to the collapse of Norse Greenland."](https://www.cam.ac.uk/stories/norsewalrus)
